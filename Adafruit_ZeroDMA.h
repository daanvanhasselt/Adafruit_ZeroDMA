...
public:
  ...
  */
  ...
  /*!
    ...
    @param  act   One of DMA_EVENT_INPUT_ACTION_NOACT, DMA_EVENT_INPUT_ACTION_TRIG,
                  DMA_EVENT_INPUT_ACTION_CTRIG, DMA_EVENT_INPUT_ACTION_CBLOCK,
                  DMA_EVENT_INPUT_ACTION_SUSPEND or DMA_EVENT_INPUT_ACTION_RESUME for desired behavior.
                  If DMA_EVENT_INPUT_ACTION_NOACT is passed, the EVIE bit is automatically set to 0.
